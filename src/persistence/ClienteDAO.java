...
public class ClienteDAO implements IClienteDAO {
	...
	public List<ClienteDTO> findAllOrderedByNome() throws SQLException {
        try (var conn = DBConnection.get();
             var stmt = conn.createStatement();
    ...
    public List<ClienteDTO> findAllOrderedByCpf() throws SQLException {
        try (var conn = DBConnection.get();
             var stmt = conn.createStatement();
	...
	public ClienteDTO findById(String id) throws SQLException {
		// Query SQL para buscar cliente por ID
		...
		try (Connection conn = DBConnection.get();
			...
			try (ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
					// Usar o mapper para converter ResultSet em ClienteDTO
