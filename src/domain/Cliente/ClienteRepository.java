...
public class ClienteRepository implements Repository { 
	...
	public List<Cliente> findAllOrderedByCpf() throws SQLException
	{
		// Busca todos os clientes do repositório
		var dtos = dao.findAllOrderedByCpf();
	...
	public List<Cliente> findAllOrderedByNome() throws SQLException
	{
		// Busca todos os clientes do repositório
		var dtos = dao.findAllOrderedByNome();
	...
	public Cliente findById(String id) throws SQLException {
		// Busca o cliente no repositório
		ClienteDTO dto = dao.findById(id);

		// Se o cliente existe, converte o DTO em cliente e retorna
		if (dto != null) {
			return create(dto);
		}
